!(function (e, t) {
  ...
  class RecordService extends CrudService {
    ...
    async authWithOAuth2(...e) {
      ...
      let o = null;
      function cleanup() {
        o?.close(), n.unsubscribe();
      }
      return (
        t.urlCallback || (o = openBrowserPopup(void 0)),
        new Promise(async (e, r) => {
          try {
            await n.subscribe("@oauth2", async (o) => {
              const a = n.clientId;
              try {
                if (!o.state || a !== o.state)
                  throw new Error("State parameters don't match.");
                if (o.error || !o.code)
                  throw new Error(
                    "OAuth2 redirect error or missing code: " + o.error
                  );
